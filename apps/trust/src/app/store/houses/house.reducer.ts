...
const initialState: State = {
  ...
  entities: {
    ...
    DİDİM: new House({
      ...
      classification: 'Single storey prefabricated house',
      description:
        'Every  square  of  it  is  designed  for  your  needs  and  hobbies. Therefore, only thing you need is to experience this privilege'
    }),
    ASSOS: new House({
      name: 'ASSOS',
    ...
    BERGAMA: new House({
      ...
      classification: 'Single storey prefabricated house',
      description:
        'Every  moment  is  special.  Therefore,  do  not  hesitate  to  touch upon  beauties  and  reward  yourself  and  your  beloved  ones  a beautiful life.'
    }),
    EDREMİT: new House({
      name: 'EDREMİT',
      ...
      classification: 'Single storey prefabricated house',
      description:
        'Energy and happiness surrounding you start once you get your home. Beautiful moments you share are not forgot but live for years.'
    }),
    GÖREME: new House({
      name: 'GÖREME',
      ...
      classification: 'Single storey prefabricated house',
      description:
        'Feeling  where  you  belong,  a  living  space  reflecting  on  you completely...This is what freedom is.'
    }),
    KAPADOKYA: new House({
      name: 'KAPADOKYA',
      ...
      classification: 'Single storey prefabricated house',
      description:
        'We  took  inspiration  from  life  when  we  designed  your  home. Details inside from life and city’s dynamism which can be seen only by epicures aroused on our lines.'
    }),
    KÜÇÜKYALI: new House({
      name: 'KÜÇÜKYALI',
      ...
      classification: 'Single storey prefabricated house',
      description:
        'We build environmentally friendly homes; because we know that what we give to nature will be given back.'
    }),
    MANAVGAT: new House({
      name: 'MANAVGAT',
    ...
    ABANT: new House({
      ...
      classification: 'Single storey prefabricated house',
      description:
        'Was  it  a tiresome  day?  Extend  your feet,  let  your  self  into the arms of your home and start living again.'
    }),
    ÜRGÜP: new House({
      name: 'ÜRGÜP',
    ...
    DATÇA: new House({
      ...
      classification: 'Single storey prefabricated house',
      description:
        'There are some things that have not lost their meanings yet... So, we keep them alive at your home with love.'
    }),
    ÇEŞME: new House({
      name: 'ÇEŞME',
      ...
      classification: 'Single storey prefabricated house',
      description:
        'Bells’  laughs  surround  your  living  space  like  an  impressive melody. Being mesmerized has not been that beautiful before.'
    }),
    SAKLIKENT: new House({
      name: 'SAKLIKENT',
      ...
      classification: 'Single storey prefabricated house',
      description:
        'Happiness and beautiful moments are not to be delayed. Because future for your beloved ones starts from today.'
    }),
    ...
    ALAÇATI: new House({
      ...
      classification: 'Single storey prefabricated house',
      description:
        'Beauty is in the eye of the beholder. It is time to live your dreams in houses suitable to everyone’s taste.'
    }),
    AVŞA: new House({
      name: 'AVŞA',
    ...
    AKÇAY: new House({
      ...
      classification: 'Double storey prefabricated house',
      description:
        'The most beautiful things that warm your home are your laughs and unforgettable memories you shared',
      floors: 2
    }),
    AMASRA: new House({
      name: 'AMASRA',
      ...
      classification: 'Double storey prefabricated house',
      description:
        'Your home is ready whereever you want to be. It is your choice. Maybe a wind coming from see greets you or you start the day with the amazing smell of pine trees.',
      floors: 2
    }),
    URLA: new House({
      name: 'URLA',
    ...
    YALIKAVAK: new House({
      ...
      classification: 'Double storey prefabricated house',
      description:
        'It is not only the sun scattering through curtain that lights your home... it is also the smiles of your beloved ones.',
      floors: 2
    }),
    MİLAS: new House({
      name: 'MİLAS',
    ...
    CUNDA: new House({
      ...
      classification: 'Double storey prefabricated house',
      description:
        'We thought of everything that creates a value for your life. It has only been left to you to live them.',
      floors: 2
    }),
    ERDEK: new House({
      name: 'ERDEK',
    ...
    HALİKARNAS: new House({
      ...
      classification: 'Double storey prefabricated house',
      description:
        'Smile, the most beautiful decoration of your home is the moments in which you are with beloved ones and have fun with them.',
      floors: 2
    })
  }
};
